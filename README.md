...
<div class="equation" align="center" data-raw-text="\sigma = \tfrac{s\pi}{\sqrt{3}}" data-equation="eq:logistic_stdev">
    <img src="https://cdn.rawgit.com/stdlib-js/stdlib/7e0a95722efd9c771b129597380c63dc6715508b/lib/node_modules/@stdlib/stats/base/dists/logistic/stdev/docs/img/equation_logistic_stdev.svg" alt="Standard deviation for a logistic distribution.">
    <br>
</div>
...
```bash
npm install @stdlib/stats-base-dists-logistic-stdev
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-logistic-stdev/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/stats-base-dists-logistic-stdev/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-dists-logistic-stdev
